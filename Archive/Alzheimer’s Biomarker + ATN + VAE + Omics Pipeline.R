...
# 
# A??42/40 ratio < 0.067: Nakamura et al. (2018) JAMA Neurology
#   "High performance plasma amyloid-?? biomarkers for Alzheimer's disease"
#   PMID: 29613453
# 
...
cutoff_refs <- data.frame(
  Biomarker = c("A??42/40 ratio", "pTau181", "NfL"),
...
roc_comparison <- data.frame(
  Biomarker = c("NfL", "GFAP", "A??42/40", "pTau181"),
...
biomarker_labels <- c(
  ...
  log_AB42_40_ratio = "A??42/40 Ratio (log-transformed)",
